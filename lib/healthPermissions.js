...
export async function checkStepPermission() {
  ...
  console.log('[HealthPermissions] Native platform detected, returning denied (not implemented)');
  return 'denied';
}
...
export async function fetchStepData(startDate, endDate) {
  ...
  // For now, generate mock data for all platforms
  // In production, this would integrate with Apple HealthKit on iOS
