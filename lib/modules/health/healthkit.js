 ...
 * @returns {Promise<Array>} Array of daily step data
 */
export async function fetchDailySteps14d() {
  console.log('[HealthKit] fetchDailySteps14d called, Platform:', Platform.OS);
  ...
  try {
    ...
    console.error('[HealthKit] Error in fetchDailySteps14d:', error);
    return [];
  }
}
