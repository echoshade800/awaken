...
/**
 * 播报模版 (Broadcast Templates)
 *
 * 预设的播报内容模版，每个模版包含一系列文本片段和模块标签。
 * content 是一个数组，每个元素可以是：
 * - { type: 'text', value: '文本内容' }
 * - { type: 'module', moduleId: '模块ID' }
 */
export const BROADCAST_TEMPLATES = [
  {
    ...
    label: 'The Host',
    content: [
      { type: 'text', value: 'Good morning! It\'s ' },
      { type: 'module', moduleId: 'time' },
      { type: 'text', value: '. Today is ' },
      { type: 'module', moduleId: 'date' },
      { type: 'text', value: ', ' },
      { type: 'module', moduleId: 'weekday' },
      { type: 'text', value: '. The weather is ' },
      { type: 'module', moduleId: 'weather' },
      { type: 'text', value: ' with a high of ' },
      { type: 'module', moduleId: 'high-temp' },
      { type: 'text', value: ' degrees. Your schedule: ' },
      { type: 'module', moduleId: 'schedule' },
      { type: 'text', value: '. Have a productive day!' },
    ]
  },
  {
    id: 'fairy-morning',
    label: 'Fairy Morning',
    content: [
      { type: 'text', value: 'Rise and shine, magical soul! The time is ' },
      { type: 'module', moduleId: 'time' },
      { type: 'text', value: '. Today\'s enchanting date is ' },
      { type: 'module', moduleId: 'date' },
      { type: 'text', value: '. The skies gift us with ' },
      { type: 'module', moduleId: 'weather' },
      { type: 'text', value: ' weather. Your lucky color today is ' },
      { type: 'module', moduleId: 'lucky-color' },
      { type: 'text', value: '. May your day sparkle with joy!' },
    ]
  },
  {
    id: 'hero-mode',
    label: 'Hero Mode',
    content: [
      { type: 'text', value: 'Wake up, champion! It\'s ' },
      { type: 'module', moduleId: 'time' },
      { type: 'text', value: ' and time to conquer ' },
      { type: 'module', moduleId: 'weekday' },
      { type: 'text', value: '! The forecast shows ' },
      { type: 'module', moduleId: 'weather' },
      { type: 'text', value: '. Your device is charged at ' },
      { type: 'module', moduleId: 'battery' },
      { type: 'text', value: ', ready for action. Today\'s mission: ' },
      { type: 'module', moduleId: 'schedule' },
      { type: 'text', value: '. Let\'s do this!' },
    ]
  },
  {
    id: 'pet-buddy',
    label: 'Pet Buddy',
    content: [
      { type: 'text', value: 'Woof woof! Good morning, ' },
      { type: 'module', moduleId: 'nickname' },
      { type: 'text', value: '! It\'s ' },
      { type: 'module', moduleId: 'time' },
      { type: 'text', value: ' on this lovely ' },
      { type: 'module', moduleId: 'weekday' },
      { type: 'text', value: '. You slept for ' },
      { type: 'module', moduleId: 'sd' },
      { type: 'text', value: '. Outside it\'s ' },
      { type: 'module', moduleId: 'weather' },
      { type: 'text', value: '. Here\'s a tip: ' },
      { type: 'module', moduleId: 'random-tip' },
      { type: 'text', value: '. Let\'s have an amazing day together!' },
    ]
  },
  {
    id: 'dream-voice',
    label: 'Dream Voice',
    content: [
      { type: 'text', value: 'Softly awakening... it\'s ' },
      { type: 'module', moduleId: 'time' },
      { type: 'text', value: '. You dreamed of ' },
      { type: 'module', moduleId: 'dream-link' },
      { type: 'text', value: '. Your sleep duration was ' },
      { type: 'module', moduleId: 'sd' },
      { type: 'text', value: '. Today is ' },
      { type: 'module', moduleId: 'date' },
      { type: 'text', value: ', and the weather whispers ' },
      { type: 'module', moduleId: 'weather' },
      { type: 'text', value: '. Gentle transitions into your day await...' },
    ]
  },
  {
    id: 'custom',
